function [Ireg,O_trans,Spacing,M,param,B,F] = image_registration(Imoving,Istatic,Options)
...
param = []; % added by GB to get parameters fo the estimation
if(~strcmpi(Options.Registration(1),'N'))
    [M,param]=affine_registration(O_trans,Spacing,Options,Imoving,Istatic,MASKmoving,MASKstatic,type,Points1,Points2,PStrength,IS3D);
else M=[];
end
...
function [M,x]=affine_registration(O_trans,Spacing,Options,Imoving,Istatic,MASKmoving,MASKstatic,type,Points1,Points2,PStrength,IS3D)
