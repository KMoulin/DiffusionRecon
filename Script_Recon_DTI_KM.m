...
%%%%%%%%%%%%%%% Create ROI %%%%%%%%%
if UI.roi_mode    
     [P_Endo,P_Epi,LV_Mask,Mask_Depth]= ROI_KM(Trace(:,:,:,1));
...
if UI.DTI_mode
   ...
   %%%%%%%%%%%%%% Extract HA %%%%%%%%%%%%%
    if UI.roi_mode
        ...
        save([enum.dcm_dir '/Maps/HA2.mat'],'EigVect1','EigVect2','EigVect3','Elevation','HA','TRA','HA_filter','HA2','TRA2','E2A','HA_filter2');        
        
        figure,imagescn(HA2.*LV_Mask,[-90 90]),colormap('jet')
        figure,imagescn(HA_filter2.*LV_Mask,[-90 90]),colormap('jet')
    end
end
%%
